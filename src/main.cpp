...
uint256 hashGenesisBlock("0x46e7a3c2a0d15afec689e1dff77718acf27edeb2ee797f0b9160b47d6583cfef");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Kannacoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Kannacoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Kannacoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x330aafc99b50512cf7f1410f8db6e138402a7f8c92ed284fe664dae4b5f409a5");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "State Legalized Marijuana Coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0455c2329e2cdb3524fd14ae58797ddb6c366ad7e71f3202fec3adc3ebb3f7caa6237ba10c18d1d5fa59963d6ec64035aa56003ec21923809802e1dff241cbe23a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1544202724;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084728885;

        if (fTestNet)
        {
            block.nTime    = 1544202706;
            block.nNonce   = 385778788;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xfb4ab02b89af16360c592bce524a85edea791de98d876d07ea467b580f2b93a1"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfd, 0xca, 0xb1, 0xda }; // Kannacoin: increase each by adding 2 to bitcoin's value.
